...
const Fleet = () => {
  ...
  return (
    <section id="fleet" className="section-padding bg-background relative overflow-hidden">
      <div className="absolute -top-20 -right-20 w-96 h-96 rounded-full bg-[hsl(24,100%,50%)/0.04] blur-3xl pointer-events-none" />
      <div className="absolute -bottom-20 -left-20 w-96 h-96 rounded-full bg-[hsl(340,80%,55%)/0.03] blur-3xl pointer-events-none" />
      ...
      <div className="container mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-lg max-w-2xl mx-auto text-muted-foreground mt-6 leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          >
            ...
            <div className="absolute -bottom-4 -right-4 gradient-bg text-white p-5 rounded-2xl shadow-xl hidden md:block glow-orange">
              <p className="text-3xl font-bold">34-TON</p>
              <p className="text-sm opacity-80">Side Tipper Capacity</p>
            </div>
          </motion.div>
        </div>

        <div className="mt-24">
          <h3 className="text-3xl font-bold mb-12 text-center gradient-text">Explore Our Fleet</h3>
              ...
              <CarouselContent>
                {fleetImages.map((image, index) => (
                  <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/3">
                    <div className="p-2">
                      <div className="rounded-2xl overflow-hidden apple-card">
